  ...
  return (
    <footer className="bg-[#596A7D] text-slate-100 py-12 px-6 border-t border-slate-600">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
        ...
        {/* BRAND IDENTIFIER - SWAPPED IN CRISP NEW LOGO IMAGE */}
        ...
        <div>
          ...
          <ul className="space-y-2 text-xs font-bold text-slate-200">
            <li><Link href="/how-it-works" className="hover:text-[#FF5F1F] transition-colors">How It Works</Link></li>
      ...
      <div className="max-w-7xl mx-auto mt-6 text-[10px] text-slate-300/80 leading-relaxed font-medium border-t border-slate-600/50 pt-4">
        <strong>Disclaimer:</strong> SubShield is an automated document screening platform and productivity tool. SubShield is not a law firm, does not provide formal legal representation, opinions, or counsel, and does not monitor federal circular updates autonomously.
      </div>
    </footer>
  );
}