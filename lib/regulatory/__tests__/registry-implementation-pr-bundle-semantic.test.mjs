...
const plan = {
  ...
  sourceId: SOURCE_ID,
  reviewRecordChecksum: sha256("semantic-regression-review-record"),
...
const baselinePlan = {
  ...plan,
  planId: "regulatory-implementation-plan:baseline-only-semantic-regression",
  planChecksum: sha256("baseline-only-semantic-regression-plan"),
  sourceId: BASELINE_SOURCE_ID,
  reviewRecordChecksum: sha256("baseline-only-semantic-review-record"),
  targetBranch: "regulatory/baseline-only-semantic-regression",
  steps: [baselineStep],
};
