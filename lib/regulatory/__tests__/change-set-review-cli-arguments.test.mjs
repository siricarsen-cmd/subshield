...
check(
  "valid approval arguments produce strict roots, review kinds, and benchmark attestation",
...
check(
  "valid rejection arguments require no release or benchmark approval fields",
