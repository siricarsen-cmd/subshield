...
check(
  "CMMC catalog entry is identified for correction to the official subchapter-G route before live retrieval",
  cmmcCatalog?.canonicalUrl.includes("/part-170") &&
    !cmmcCatalog.canonicalUrl.includes("/subchapter-G/")
);
