...
check(
  "a source-preserving benchmark template change with official evidence is a valid pending change set",
...
mismatchedCoordinated.changes.find(
  (candidate) => candidate.kind === "historical-policy"
).afterValue.sourcePolicies.push(
  structuredClone(policyEntry.value.sourcePolicies[0])
);
