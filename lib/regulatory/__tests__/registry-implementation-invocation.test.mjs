...
try {
  ...
  pass(
    !Object.hasOwn(futureSkewAuthorization, "createdAtMs"),
    "process-observed creation time is not serialized into authorization"
  );
  testNow = testBaseMs + 5 * 60_000 + 1;
  ...
  pass(
    !JSON.stringify(storedAudit).includes("createdAtMs"),
    "process-observed creation time is not retained in audit evidence"
  );
  equal(
    validateRegulatoryImplementationInvocationAuditRecord(
      storedAudit,
