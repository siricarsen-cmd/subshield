...
check(
  "contract execution date selects the historical version effective on that date",
...
const noEligible = selectRegulatoryVersionForDate(
  ...
  { ...contractContext, asOfDate: "2025-02-01" }
);
check(
...
check(
  "an explicitly user-specified date may be selected without fabricating a contract quote",
