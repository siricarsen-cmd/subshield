...
2.8 Invoice Requirements
Failure to submit a complete invoice within 30 calendar days waives Subcontractor's right to payment. Subcontractor's right to payment for the affected invoice is not waived during the cure period.
`);
check(
...
check(
  ...
  Boolean(sameSentenceMixedInvoiceWaiverFinding?.riskAnalysis?.includes("45 calendar days"))
);
