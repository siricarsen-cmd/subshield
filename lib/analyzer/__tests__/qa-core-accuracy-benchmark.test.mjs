...
// The withholding, construction-rework, and wage-clause assertions specifically
// preserve the three QA-D gaps first exposed when this benchmark was introduced.
