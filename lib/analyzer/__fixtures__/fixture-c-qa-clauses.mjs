...
export const PRIME_DIRECTED_RESPONSE_COSTS_CLAUSE =
  "4.4 Following a cyber incident, Prime may direct containment, system isolation, credential reset, system shutdown, evidence collection, employee interviews, forensic imaging, customer notification, or incident restoration actions. Subcontractor shall comply immediately and bear all associated cost.";
